<?php session_start();
 ...
 //mysql://be7502081e1fd6:6e9984ad@us-cdbr-iron-east-05.cleardb.net/heroku_8c2e9da35585d79?reconnect=true
		...
		<div class="top-header container-fluid no-padding">
			<div class="container">
				<div class="topheader-left">
					<a href="tel:+2348163922749"><i class="fa fa-mobile" aria-hidden="true"></i>+234 81 639 227 49</a>
					<a href="mailto:info@jakomita.com" ><i class="fa fa-envelope-o" aria-hidden="true"></i>info@jakomita.com</a>
				</div>
				<div class="topheader-right">
					<a href="signin"><i class="fa fa-sign-out" aria-hidden="true"></i>Login</a>
					<a href="signup"><i class="fa fa-pencil" aria-hidden="true"></i>Register</a>
					...
					<nav class="navbar ow-navigation">
						<div class="col-md-3">
							<div class="navbar-header">
								...
								<a  href="./"><img src="images/logo2.png" class="logo-img " alt="logo" id="logochange" /><!-- Jakomita<span>Education of Best</span --></a>
