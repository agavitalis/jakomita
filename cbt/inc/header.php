		...
		<div class="top-header container-fluid no-padding">
			<div class="container">
				<div class="topheader-left">
					<a href="tel:+23481 639 2749"><i class="fa fa-mobile" aria-hidden="true"></i>+234 459 900 44 </a>
					...
					<nav class="navbar ow-navigation">
						<div class="col-md-3">
							<div class="navbar-header">
								...
								<a  href="./"><img src="../images/logo2.png"  class="logo-img" alt="logo" id="logochange" /></a>
							</div>
						</div>
						<div class="col-md-9">
