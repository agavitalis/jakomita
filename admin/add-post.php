...
<main>
  ...
  <textarea name="cat_description" class="materialize-textarea" placeholder="Category Description" id="category_description"></textarea>
...
<form style="width: 80%; margin:0 auto" method="post" id="forum_post" enctype="multipart/form-data">
  ...
  <select name="post_category" id="post_category">
    ...
    <?php 
      $selectcategory = mysqli_query($conn,"SELECT * FROM forum_categories ORDER BY forum_cat_name");
      while ($row = mysqli_fetch_array($selectcategory)) {
        $cat_id = $row['forum_cat_id'];
        $cat_name =$row['forum_cat_name'];
...
<script src="inc/forum_post.js"></script>
...
<script type="text/javascript">
  ...
  document.getElementById('inputImg').addEventListener("change",function(){
    ...
    var inputImg = document.getElementById('inputImg');
      ...
      ajax.open("POST", "inc/add_pix.php", true);
