...
<main>
  <table class="responsive-table striped bordered" >
    <h5 class="center">All Forum Posts</h5>
 <thead>
   <tr>
    <th>Title</th>
    <th>Body</th>
 ...
 <tbody>
  <?php 
  $fetchallposts = mysqli_query($conn,"SELECT forum_topic.*, users.* from forum_topic INNER JOIN users WHERE forum_topic.topic_by = users.profile_id ORDER BY topic_date DESC");
  ...
  <tr>
    ...
    <td><a href="#"><i id="<?php echo $forum_topic_id; ?>" class="mdi mdi-24px brown-text mdi-grease-pencil edit"></i></a></td>
    <td><a href="#"><i id="<?php echo $forum_topic_id; ?>" class="mdi mdi-24px brown-text mdi-delete-variant delete"></i></a></td>
  </tr>
   <?php 
    }
 ?>
...
<script type="text/javascript">
  ...
  $(".edit").click(function(){
    id = $(this).attr('id');
    window.location.href = "edit_forum_post?topic="+id;
  });
</script>
